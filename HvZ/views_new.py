...
class RegForm(forms.Form):
	...
	dorm = forms.ModelChoiceField(queryset=Building.objects.filter(buildingkind.kind='D').order_by('name'),required=True,empty_label="Off Campus",help_text="<div class='reminder'>Select which dorm you expect to sleep in on most nights during the game. If you do not live on campus, select \"Off Campus\"</div>")
